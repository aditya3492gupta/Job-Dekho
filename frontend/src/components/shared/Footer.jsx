            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                        <h2 className="text-xl font-bold">Job Dekho</h2>
                        <p className="text-sm">© 2024 Your Company. All rights reserved.</p>
                    </div>

                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://www.facebook.com/profile.php?id=100005336764676" className="hover:text-gray-400" aria-label="Facebook">
                        ...
                        <a href="https://x.com/adityasvarshney" className="hover:text-gray-400" aria-label="Twitter">
                        ...
                        <a href="https://www.linkedin.com/in/aditya-gupta-227581227/" className="hover:text-gray-400" aria-label="LinkedIn">
